    ...
    const blocked =
      blocks.some(block => {
        ...
        const blockStartTime =
          new Date(
            `2000-01-01T${String(blockStart.getHours()).padStart(2, "0")}:${String(blockStart.getMinutes()).padStart(2, "0")}:00`
          );

        const blockEndTime =
          new Date(
            `2000-01-01T${String(blockEnd.getHours()).padStart(2, "0")}:${String(blockEnd.getMinutes()).padStart(2, "0")}:00`
          );

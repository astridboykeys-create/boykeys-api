...
export function removeUnavailableSlots(
  ...
  return slots.filter(slot => {
    ...
    return !periods.some(period => {
      ...
      console.log("Period start:", period.start);
      console.log("Period end:", period.end);

      console.log("PeriodStart Date:", periodStart);
      console.log("PeriodEnd Date:", periodEnd);
      ...
      console.log("BlockStart:", start);
      console.log("BlockEnd:", end);
